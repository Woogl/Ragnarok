...
void ARagnarokCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("Move Right / Left", this, &ARagnarokCharacter::MoveRight);
...
void ARagnarokCharacter::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
...
void ARagnarokCharacter::MoveRight(float Value)
{
	if ( (Controller != nullptr) && (Value != 0.0f) )
	{
